...
// je requiers la requête de selection qui est dans le fichier sqlSelectDatasReg_mod.php, ici.
require_once '../modeles/sqlSelectDatasReg_mod.php';
// je requiers la requête d'insertion des données en Bdd qui est dans le fichier sqlInsertDatasReg_mod.php, ici.
require_once '../modeles/sqlInsertDatasReg_mod.php';
