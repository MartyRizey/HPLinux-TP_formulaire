...
<div class="modal" id="modalInscription">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <!-- Je transmet les données saisies dans le fichier insertDatasRegistration_ctrl.php -->
        <form action="../Controllers/insertDataRegistration_ctrl.php" method="POST">
          ...
          <div class="input_form input_form-reg_bkgd">
            ...
            <!--
              [x] : Hacher le mot de passe avec password_hash(), le stocker en Bdd.Vérifier à la connexion que le password saisie dans le formulaire de conexion corresponde avec le mot de passe hacher en Bdd avec password_verify().
            -->
